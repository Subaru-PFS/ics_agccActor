...
class Camera(object):
    ...
    def expose(self, cmd, expTime, expType, cams, combined, centroid, pfsVisitId, cParms):
        ...
        if expType == 'test':
            ...
            exp_thr = Exposure(active_cams, expTime_ms, dflag, cParms, pfsVisitId, cmd, combined, centroid)
            exp_thr.start()
